...
//   // Warna
//   static const Color _backgroundColor = Color.fromARGB(255, 170, 184, 171);// Lebih terang, sedikit "dingin"
//   static const Color _cardColor = Color.fromARGB(255, 230, 238, 230);  // Tetap terang
...
//   static const Color _antiDesignAccentColor = Color(0xFF000000); // Warna aksen yang kontras/berani (Merah)
...
//                     ),
//                   ),
//                   const SizedBox(height: 65), // Jarak tidak biasa

//                   // Card Kalori (Geser sedikit ke kiri, tumpang tindih)
//                   Transform.translate(
//                     offset: const Offset(0, 0), // Geser dan tumpang tindih
...
//         //   style: _scanTextStyle.copyWith(color: _brandColorGreen),
