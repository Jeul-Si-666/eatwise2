...
// import 'package:eatwise2/services/login_service.dart';
  ...
  try {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResp['user'] != null) {
        ...
        await prefs.setString('user_id', jsonData['user']['id'].toString()); // TAMBAHKAN INI
        ...
        // await prefs.setBool(IS_LOGIN, true);
        // await prefs.setString('user_id', userData['id'].toString()); // ✅ Konversi ke String
      ...
      //   print("Bagian response json resp ");
      ...
      //   print("Data User Ditemukan: " + userData.toString());
        ...
        // print("User ID: " + userData['id'].toString()); // Output: "3"
        // print("Username:" + userData['username'].toString()); // Output: "Prabowo"
        ...
        // await prefs.setBool(IS_LOGIN, true);
        // await prefs.setInt('user_id', jsonData['user']['id']); // TAMBAHKAN INI
        // await prefs.setString('username'.toString(), jsonData['user']['username']);
        // await prefs.setInt('user_id', jsonData['user']['id']);

        // Pindah halaman (Alhamdulillah sukses)
        // Navigator.pushReplacement(
        //   context,
        //   MaterialPageRoute(builder: (context) => Indexhome.HomeContent())
        //   // MaterialPageRoute(builder: (context) => UserProfile.UserProfileScreen())
        //   // MaterialPageRoute(builder: (context) => HasilPage.ReportScreen(report: HasilPage.reportAman) )
        // );
